...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__pow(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__powResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__div(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__divResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__mul(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__mulResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__sub(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns2__subResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
